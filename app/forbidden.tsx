...
export default function Forbidden() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-zinc-50 px-4 font-sans antialiased dark:bg-black">
      ...
      <div className="absolute top-1/4 left-1/4 -z-10 h-96 w-96 rounded-full bg-rose-500/10 blur-3xl dark:bg-rose-500/20" />
      <div className="absolute right-1/4 bottom-1/4 -z-10 h-96 w-96 rounded-full bg-amber-500/10 blur-3xl dark:bg-amber-500/20" />
      ...
      <div className="relative w-full max-w-xl text-center">
        {/* Animated Icon Badge */}
        <div className="mx-auto mb-8 flex h-24 w-24 items-center justify-center rounded-2xl bg-rose-500/10 text-rose-600 shadow-inner ring-1 ring-rose-500/20 dark:bg-rose-500/20 dark:text-rose-400 dark:ring-rose-500/30">
          <ShieldAlert className="h-12 w-12 animate-pulse" />
        </div>

        {/* Status Code with Premium Gradient */}
        <h1 className="mb-4 bg-gradient-to-r from-rose-600 via-orange-600 to-amber-600 bg-clip-text text-8xl font-black tracking-tight text-transparent dark:from-rose-400 dark:via-orange-400 dark:to-amber-400 sm:text-9xl">
          403
        </h1>
        ...
        <p className="mx-auto mb-10 max-w-md text-base leading-relaxed text-zinc-600 dark:text-zinc-400">
          Maaf, Anda tidak memiliki izin atau otoritas yang cukup untuk mengakses halaman ini. Jika Anda yakin ini adalah kesalahan, silakan hubungi tim administrator.
        </p>
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <Link
            href="/"
            className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-rose-600 to-orange-600 px-5 text-sm font-semibold text-white shadow-lg shadow-rose-500/20 transition-all hover:from-rose-500 hover:to-orange-500 hover:shadow-rose-500/30 dark:shadow-rose-500/10 sm:w-auto"
          >
