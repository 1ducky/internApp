...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://sgintern.my.id/about/about-metadata.webp",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://sgintern.my.id/about/about-metadata.webp"], // TODO: Ganti dengan path gambar thumbnail yang sama
  },
};
